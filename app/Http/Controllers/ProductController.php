...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'name' => 'ÇÓã ÇáãäÊÌ',
            'purchase_method' => 'äæÚ ÇáÔÑÇÁ',
            'quantity' => 'ÚÏÏ ÇáÍÈÇÊ',
            'wholesale_price' => 'ÓÚÑ ÇáÍÈÉ ÈÇáÌãáÉ',
            'transport_cost' => 'ÊßáİÉ ÇáãæÇÕáÇÊ',
            'extra_cost' => 'ÇáãÕÇÑíİ ÇáÅÖÇİíÉ',
        ]);
        ...
        return redirect()->route('products.index')->with('success', 'ÊãÊ ÅÖÇİÉ ÚãáíÉ ÇáÔÑÇÁ ÈäÌÇÍ.');
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        if ($validated['quantity'] < $soldQuantity) {
            return back()
                ->withInput()
                ->withErrors(['quantity' => 'áÇ íãßä Ãä íßæä ÚÏÏ ÇáÍÈÇÊ ÃŞá ãä ÇáßãíÉ ÇáãÈÇÚÉ ãÓÈŞğÇ (' . $soldQuantity . ').']);
        }
        ...
        return redirect()->route('products.index')->with('success', 'Êã ÊÚÏíá ÚãáíÉ ÇáÔÑÇÁ ÈäÌÇÍ.');
    }
}
