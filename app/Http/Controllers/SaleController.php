...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'product_id' => 'ÇáãäÊÌ',
            'sale_method' => 'äæÚ ÇáÈíÚ',
            'quantity_sold' => 'ÚÏÏ ÇáÍÈÇÊ ÇáãÈÇÚÉ',
            'sale_price' => 'ÓÚÑ ÇáÈíÚ ááÍÈÉ',
            'sale_date' => 'ÊÇÑíÎ ÇáÈíÚ',
        ]);
        ...
        if ($validated['quantity_sold'] > $remaining) {
            return back()
                ->withInput()
                ->withErrors(['quantity_sold' => 'ÇáßãíÉ ÇáãÈÇÚÉ ÃßÈÑ ãä ÇáãÊÈŞí. ÇáãÊÇÍ ÍÇáíğÇ: ' . $remaining . ' ÍÈÉ.']);
        }
        ...
        return redirect()->route('sales.index')->with('success', 'Êã ÊÓÌíá ÚãáíÉ ÇáÈíÚ ÈäÌÇÍ.');
    }
    ...
    public function destroy(Sale $sale)
    {
        ...
        $sale->delete();
        return redirect()->route('sales.index')->with('success', 'Êã ÍĞİ ÚãáíÉ ÇáÈíÚ ÈäÌÇÍ.');
    }
}
